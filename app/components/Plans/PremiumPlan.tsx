export default function PremiumPlan() {
  return (
    <div
      className="w-[392px] h-[614px] rounded-[24px] border border-[#E7EBFF] p-[32px] flex flex-col items-center"
      style={{
        background:
          "radial-gradient(129.76% 100% at 50.04% 100%, rgba(3,25,83,0.7) 0%, rgba(24,116,255,0.7) 100%)",
      }}
    >
      <div className="flex flex-col w-[328px] h-[534px] gap-[24px]">
        ...
        <div className="flex flex-col w-[328px] gap-[16px]">
